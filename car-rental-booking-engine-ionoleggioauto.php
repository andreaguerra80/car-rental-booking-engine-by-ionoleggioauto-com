<?php
/**
 * Plugin Name: Earn Money with Car Rental Booking Engine by Ionoleggioauto.com
 * Text Domain: c-h-ionoleggioauto
 * Plugin URI: https://www.ionoleggioauto.com/plugin-wordpress-ionoleggioauto/
 * Description: Add a search box to your website so your visitors can search and compare car hire prices worldwide.
 * Version: 1.1
 * Author: Ionoleggioauto.com
 * Author URI: http://www.ionoleggioauto.com
 * License: GPL2
 */


/*  Copyright 2018  Ionoleggioauto.com
...
function c_h_h_init(){
	...
	// Localization
	load_plugin_textdomain('c-h-ionoleggioauto', false, dirname(plugin_basename(__FILE__)) . '/languages/');
}
...
class chh_plugin_widget extends WP_Widget {
	...
	function chh_plugin_widget() {
		parent::WP_Widget(false, $name = 'Car Rental Booking Engine by Ionoleggioauto.com' );
	}
	...
	<p>
	<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Widget Title', 'c-h-ionoleggioauto'); ?></label>
...
function c_h_h_plugin_settings_link($links) { 
  $settings_link = '<a href="options-general.php?page=car-hire-ionoleggioauto">' . __('Settings', 'c-h-ionoleggioauto') . '</a>'; 
...
// Create the page
add_action('admin_menu', 'car_hire_ionoleggioauto_admin_add_page');

function car_hire_ionoleggioauto_admin_add_page() {
	add_options_page('Car Rental Booking Engine by Ionoleggioauto.com Settings', 'Car Rental Booking Engine by Ionoleggioauto.com', 'manage_options', 'car-hire-ionoleggioauto', 'car_hire_ionoleggioauto_options_page');
}


function car_hire_ionoleggioauto_options_page() {

	echo "\n<div>";
	echo "\n<h2>" . __('Car Rental Booking Engine by Ionoleggioauto.com Settings', 'c-h-ionoleggioauto') . "</h2>";
	echo '<img src="' . plugins_url( '/images/noleggioauto.png', __FILE__ ) . '" > ';


	echo "\n<form action=\"options.php\" method=\"post\">";
	
	settings_fields('car_hire_ionoleggioauto_options');
	do_settings_sections('car-hire-ionoleggioauto');
	
	//echo "\n<input name=\"Submit\" type=\"submit\" value=\"" . esc_attr_e('Save Changes') . "\" />";
	echo "\n<br/>";
	echo "\n<input name=\"Submit\" type=\"submit\" value=\"" . __('Save Changes', 'c-h-ionoleggioauto') . "\" />";
	echo "\n</form></div>";
...
// Create the settings
add_action('admin_init', 'car_hire_ionoleggioauto_admin_init');

function car_hire_ionoleggioauto_admin_init(){
	register_setting( 'car_hire_ionoleggioauto_options', 'c_h_h_options', 'c_h_h_options_validate' );
	add_settings_section('c_h_h_main','', 'c_h_h_section_text', 'car-hire-ionoleggioauto');


	// Add the fields
	add_settings_field('c_h_h_title', __('Title', 'c-h-ionoleggioauto'), 'c_h_h_title_setting', 'car-hire-ionoleggioauto', 'c_h_h_main');
	//add_settings_field('c_h_h_af_cod', __('Affiliate ID', 'c-h-ionoleggioauto'), 'c_h_h_af_cod_setting', 'car-hire-ionoleggioauto', 'c_h_h_main');
	add_settings_field('c_h_h_a_aid', __('Affiliate ID', 'c-h-ionoleggioauto'), 'c_h_h_a_aid_setting', 'car-hire-ionoleggioauto', 'c_h_h_main');
	add_settings_field('c_h_h_lang', __('Search box language', 'c-h-ionoleggioauto'), 'c_h_h_lang_setting', 'car-hire-ionoleggioauto', 'c_h_h_main');
	add_settings_field('c_h_h_pickup', __('Default location id (optional)', 'c-h-ionoleggioauto'), 'c_h_h_pickup_id_setting', 'car-hire-ionoleggioauto', 'c_h_h_main');
	add_settings_field('c_h_h_width', __('Width', 'c-h-ionoleggioauto') . ' (%)', 'c_h_h_width_setting', 'car-hire-ionoleggioauto', 'c_h_h_main');
	add_settings_field('c_h_h_color', __('Foreground color', 'c-h-ionoleggioauto') . ' (#rrggbb)', 'c_h_h_color_setting', 'car-hire-ionoleggioauto', 'c_h_h_main');
	add_settings_field('c_h_h_background_color', __('Background color', 'c-h-ionoleggioauto') . ' (#rrggbb)', 'c_h_h_background_color_setting', 'car-hire-ionoleggioauto', 'c_h_h_main');
	add_settings_field('c_h_h_button_color', __('Button color', 'c-h-ionoleggioauto') . ' (#rrggbb)', 'c_h_h_button_color_setting', 'car-hire-ionoleggioauto', 'c_h_h_main');
	add_settings_field('c_h_h_button_text_color', __('Button text color', 'c-h-ionoleggioauto') . ' (#rrggbb)', 'c_h_h_button_text_color_setting', 'car-hire-ionoleggioauto', 'c_h_h_main');
	add_settings_field('c_h_h_border_width', __('Border width', 'c-h-ionoleggioauto'), 'c_h_h_border_width_setting', 'car-hire-ionoleggioauto', 'c_h_h_main');
	add_settings_field('c_h_h_border_color', __('Border color', 'c-h-ionoleggioauto'), 'c_h_h_border_color_setting', 'car-hire-ionoleggioauto', 'c_h_h_main');
	add_settings_field('c_h_h_border_radius', __('Border radius', 'c-h-ionoleggioauto'), 'c_h_h_border_radius_setting', 'car-hire-ionoleggioauto', 'c_h_h_main');
...
//	echo "<input id='af_cod_text_string' name='c_h_h_options[af_cod]' size='40' type='text' value='{$options['af_cod']}' /><br/><small><a href='https://www.ionoleggioauto.com/accesso-affiliati/" . $lang //. "/register/' target='_blank'>" . __('How do I get one?', 'c-h-ionoleggioauto') . "</a></small>";
//}
function c_h_h_a_aid_setting() {
	$options = get_option('c_h_h_options');
	$lang = ($options['lang']) ? $options['lang'] : 'en';
	echo "<input id='a_aid_text_string' name='c_h_h_options[a_aid]' size='40' type='text' value='{$options['a_aid']}' /><br/><small><strong>Earn money with Ionoleggioauto.com</strong> - <a href='https://www.ionoleggioauto.com/accesso-affiliati/' target='_blank'>" . __('Join our affiliate program!', 'c-h-ionoleggioauto') . "</a></small>";
}
...
function c_h_h_pickup_id_setting() {
	$options = get_option('c_h_h_options');
	echo "<input id='pickup_id' name='c_h_h_options[pickup_id]' size='15' type='text' value='{$options['pickup_id']}' /><br/><small><a href='#'onclick=\"javascript:window.open('http://www.ionoleggioauto.com/affiliate/id_selector.php', '', 'width=620, height=490')\">" . __('Help me find the id', 'c-h-ionoleggioauto') . "</a></small>";
}
...
function c_h_h_color_setting() {
	$options = get_option('c_h_h_options');
	echo "#<input id='color' name='c_h_h_options[color]' size='6' type='text' value='{$options['color']}' /><br/><small><a href='#' onclick=\"javascript:window.open('http://www.ionoleggioauto.com/affiliate/color.php', '', 'width=600, height=600')\">" . __('Help me find the color code', 'c-h-ionoleggioauto') . "</a></small>";
}


function c_h_h_background_color_setting() {
	$options = get_option('c_h_h_options');
	echo "#<input id='background_color' name='c_h_h_options[background_color]' size='6' type='text' value='{$options['background_color']}' /><br/><small><a href='#' onclick=\"javascript:window.open('http://www.ionoleggioauto.com/affiliate/color.php', '', 'width=600, height=600')\">" . __('Help me find the color code', 'c-h-ionoleggioauto') . "</a></small>";
}


function c_h_h_button_color_setting() {
	$options = get_option('c_h_h_options');
	echo "#<input id='color' name='c_h_h_options[button_color]' size='6' type='text' value='{$options['button_color']}' /><br/><small><a href='#' onclick=\"javascript:window.open('http://www.ionoleggioauto.com/affiliate/color.php', '', 'width=600, height=600')\">" . __('Help me find the color code', 'c-h-ionoleggioauto') . "</a></small>";
}

function c_h_h_button_text_color_setting() {
	$options = get_option('c_h_h_options');
	echo "#<input id='color' name='c_h_h_options[button_text_color]' size='6' type='text' value='{$options['button_text_color']}' /><br/><small><a href='#' onclick=\"javascript:window.open('http://www.ionoleggioauto.com/affiliate/color.php', '', 'width=600, height=600')\">" . __('Help me find the color code', 'c-h-ionoleggioauto') . "</a></small>";
}
...
function c_h_h_border_color_setting() {
	$options = get_option('c_h_h_options');
	echo "#<input id='color' name='c_h_h_options[border_color]' size='6' type='text' value='{$options['border_color']}' /><br/><small><a href='#' onclick=\"javascript:window.open('http://www.ionoleggioauto.com/affiliate/color.php', '', 'width=600, height=600')\">" . __('Help me find the color code', 'c-h-ionoleggioauto') . "</a></small>";
}
...
function c_h_h_options_validate($input) {
	...
	// Affiliate ID
	$newinput['a_aid'] = trim($input['a_aid']);
	if(!preg_match('/^[a-z0-9]{1,16}$/i', $newinput['a_aid'])) {
		$newinput['a_aid'] = '';
	}
	...
	if(!preg_match('/^[a-f0-9]{6}$/i', $newinput['border_color'])) {
		$newinput['border_color'] = '';
	}
...
add_shortcode( 'car_hire_ionoleggioauto', 'c_h_h_short' );
...
function c_h_h_render($type='full'){
	...
	$border_color		= ($options['border_color']) ? $options['border_color'] : 'fff';
	...
	$template .= "\n" . '<div id="search_box" style="border-width:' . $border_width . 'px;border-color:#' . $color . ';border-color:#' . $border_color . ';border-radius:' . $border_radius . 'px;background-color:#' . $background_color . ';color:#' . $color . '">';
	$template .= "\n" . '<form method="get" class="' . $formStyle . '" action="https://www.ionoleggioauto.com/wp-car-hire/#/vehicles" target="_blank" onsubmit="javascript:return c_h_h_validate_form()">';
	$template .= "\n" . '<h6>' . $title . '</h6><br>';
	...
	$template .= "\n" . '<input type="hidden" id="pu_location_id" name="pickupID" value="' . $defPickId . '"/>';
	...
	$template .= "\n" . '<input type="hidden" id="do_location_id" name="returnID"/>';
      //$template .= "\n" . '<input type="hidden" id="pickupName" name="pickupName" />';
      $template .= "\n" . '<input type="hidden" id="returnName" name="returnName" />';
...
$template .= "\n" . '<input type="hidden" id="af_cod" name="clientID" value="378455"/>';
	$template .= "\n" . '<input type="hidden" name="carGroupID" value="0" />';
	$template .= "\n" . '<input type="hidden" name="pickupCountryCode" value="IT" />';
	$template .= "\n" . '<input type="hidden" name="residenceID" value="IT" />';
	$template .= "\n" . '<input type="hidden" id="a_aid" name="a_aid" value="' . $a_aid . '"/>';
	...
	$template .= "\n" . '</form>';
	$template .= "\n" . '</div>';
	$template .= "\n" . '<div class="' . $formStyle . '"><div class="powered_ionoleggioauto">powered by: <a href="https://www.ionoleggioauto.com/" target="_blank"><img src="' . $plugin_url . '/Logo-no-sfondo.png" alt="Ionoleggioauto.com" style="height:30px;"/></a></div></div>';
	$template .= "\n" . '</div>';
...
function c_h_h_t($label_key, $lang){
	...
	if(!is_array($labels)){
		$rawText = "
			...
			search_cars|Buscar coches|Chercher une voiture|Fahrzeug suchen|Search for cars|Cerca un'auto|Auto's zoeken
